...
class TextInventory:
    ...
    def text_groups(self):
        ...
        yield from sorted(text_groups, key=lambda tg: tg.urn)
...
class TextGroup(Collection):
    ...
    def works(self):
        ...
        for urn in children.keys():
            ...
            #     continue
            works.append(work)
        yield from sorted(works, key=lambda w: w.urn)
...
class Work(Collection):
    ...
    def texts(self):
        ...
        return texts  # sorted(texts, key=lambda t: (t.kind, t.label))
...
class Text(Collection):
    ...
    def toc(self):
        ...
        try:
            ...
            raise ValueError(f"{self.urn} has an invalid refsDecl {e}")
