...
def link_collection(urn) -> dict:
    return {
        ...
        # "json_url": reverse("sv_atlas:library_collection", kwargs={"urn": urn}),
        # "text_url": reverse("sv_atlas:library_passage_text", kwargs={"urn": urn}),
    }
...
def link_passage(urn) -> dict:
    return {
        ...
        # "json_url": reverse("sv_atlas:library_passage_json", kwargs={"urn": urn}),
        # "text_url": reverse("sv_atlas:library_passage_text", kwargs={"urn": urn}),
    }
